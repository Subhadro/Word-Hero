class ReportManager {
    showReport() {
        ...
        document.getElementById('stat-correct').textContent = ScoreState.correctCount;
        document.getElementById('stat-mistakes').textContent = ScoreState.mistakeCount;
        document.getElementById('stat-missed').textContent = ScoreState.missedCount;
